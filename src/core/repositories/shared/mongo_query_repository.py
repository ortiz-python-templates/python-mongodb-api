...
class MongoQueryRepository(Generic[T]):
    ...
    def _build_date_range_filter(self, start_date: str, end_date: str) -> dict:
        return {
            "created_at": {
    ...
    def _build_date_range_status_filter(self, status_field: Optional[str], status_value: Optional[str], start_date: str, end_date: str) -> dict:
